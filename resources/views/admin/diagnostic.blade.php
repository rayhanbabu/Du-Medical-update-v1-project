...
<div class="card mt-2 mb-2 shadow-sm">
  ...
  <div class="row ">
               <div class="col-6"> <h5 class="mt-0">{{$test->test_name}} Diagnostic  List </h5></div>
                     <div class="col-2">
                     ...
                     <div class="col-2">
                         <div class="d-grid gap-2 d-md-flex ">
                           <a class="btn btn-info btn-sm" href="{{url('admin/test')}}" role="button"> Back </a>
                         </div>
                     </div> 
                     ...
                     <div class="col-2">
                         <div class="d-grid gap-2 d-md-flex ">
                           <a class="btn btn-primary btn-sm" href="{{url('admin/diagnostic/manage/'.$test_id)}}" role="button"> Add </a>
                         </div>
                     </div> 
         </div>
...
<script>
   ...
   var table = $('.data-table').DataTable({
       ...
       serverSide: true,
       ajax: {
           url: "{{ url('/admin/diagnostic/'.$test_id) }}",
