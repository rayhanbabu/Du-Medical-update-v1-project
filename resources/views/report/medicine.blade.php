...
<div class="card mt-2 mb-2 shadow-sm">
  <div class="card-header">
    <div class="row">
      <div class="col-8">
        <h5 class="mt-0">Medicine Report </h5>
      </div>
      <div class="col-2">
    ...
    <div class="row">
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:1 Date wise Medicine Provide </b>
            <hr>
          </div>
          <form action="{{ url('reportprint/medicine/datewise_provide') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:3 Monthly Medicine Stock</b>
            <hr>
          </div>
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:3 Monthly Medicine Provide </b>
            <hr>
          </div>
          <form action="{{ url('reportdompdf/doctor-appointment') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:4 Yearly Medicine Stock</b>
            <hr>
          </div>
          <form action="{{ url('reportdompdf/doctor-appointment') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:4 Yearly Medicine Provide </b>
            <hr>
          </div>
          <form action="{{ url('reportdompdf/doctor-appointment') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
