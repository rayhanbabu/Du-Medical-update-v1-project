...
@section('report_diagnostic','active')
@section('content')
...
<div class="card mt-2 mb-2 shadow-sm">
  <div class="card-header">
    <div class="row ">
      <div class="col-8">
        <h5 class="mt-0">Diagnostic Report </h5>
      </div>
      <div class="col-2">
    ...
    <div class="row">
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:1 Diagnostice Test Report </b>
            <hr>
          </div>
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:2 Monthly Diagnostic Report</b>
            <hr>
          </div>
          <form action="{{ url('reportdompdf/doctor-appointment') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
      ...
      <div class="col-md-4 p-2">
        <div class="card shadow-sm">
          <div class="mx-3 my-2">
            <b class="text-center">Table:3 Yearly Diagnostic Report</b>
            <hr>
          </div>
          <form action="{{ url('reportdompdf/doctor-appointment') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
